...
all: saxony-monthly-temperature.csv

station_ids : stations.csv
	@cut -f1 -d, $< > $@

KL_Monatswerte_Beschreibung_Stationen.txt:
	@wget ftp://ftp-cdc.dwd.de/pub/CDC/observations_germany/climate/monthly/kl/historical/KL_Monatswerte_Beschreibung_Stationen.txt
